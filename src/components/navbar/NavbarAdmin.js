...
import Logo from "../../assets/img/avenue5-logo.png";
...
export default function AdminNavbar(props) {
  ...
  let navbarBg = useColorModeValue("#000", "rgba(11,20,55,0.5)");
      ...
      >
        ...
        >
          ...
          <Box
            ...
            style={{ fontSize: "25px" }}
          >
            {openSidebar ? <AiOutlineMenuFold color="white" /> : <AiOutlineMenuUnfold color="white" />}
          </Box>
