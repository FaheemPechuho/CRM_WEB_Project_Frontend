...
import APK from "../../../assets/crm-app.apk";
...
function SignIn() {
  ...
  return (
    <div>
        <div id="login-screen-bg" className="fixed top-0 w-screen h-screen -z-1"></div>
      ...
      >
        <Flex
        background={"#0000002b"}
        className="px-[50px] py-[30px] z-10"
          ...
          >
            <form onSubmit={handleSubmit}>
              ...
              >
                ...
                <p style={{color: "grey", margin: "12px 0", textAlign: "center"}}>OR</p>
                <Link
                href="#"
                onClick={() => {
                  window.open(APK);
