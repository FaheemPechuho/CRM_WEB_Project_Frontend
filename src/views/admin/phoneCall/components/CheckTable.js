...
export default function CheckTable(props) {
  ...
  const toggleColumnVisibility = (columnKey) => {
    ...
    isColumnSelected = tempSelectedColumns?.some(
      (column) => column?.Header === columnKey
    );
        ...
        (item) =>
          ...
          (!values?.createByName ||
            (item?.createByName &&
              item?.createByName
                .toLowerCase()
                .includes(values?.createByName?.toLowerCase())))
      );
      let getValue = [
        values.senderName,
        values?.realetedTo,
          ...
          ?.map((rec) => {
            ...
            csvColumns.forEach((property) => {
              if (property.Header === "Realeted To") {
                selectedFieldsData[property.accessor] = rec?.createByLead
                  ? "lead"
                  : rec.createBy
                  ? "contact"
                  : "";
              } else if (property.Header === "Created") {
                selectedFieldsData[property.accessor] = moment(
                  rec?.timestamp
                ).format("D/MM/YYYY LT");
              } else {
                    ...
                    <Tr {...row?.getRowProps()} key={i}>
                      {row?.cells?.map((cell, index) => {
                        ...
                        if (cell?.column.Header === "#") {
                          ...
                          data = (
                            <>
                              {cell?.row?.original?.createBy &&
                              contactAccess?.view ? (
                                <Link
                                  to={`/contactView/${cell?.row?.original.createBy}`}
                                >
                                  <Text
                                    me="10px"
                                    sx={{
                              ...
                              {leadAccess?.view &&
                              cell?.row?.original.createByLead ? (
                                <Link
                                  to={`/leadView/${cell?.row?.original.createByLead}`}
                                >
                                  <Text
                                    me="10px"
                                    sx={{
                                ...
                                >
                                  {access?.view && (
                                    <MenuItem
                                      ...
                                      onClick={() =>
                                        navigate(
                                          `/phone-call/${cell?.row?.values._id}`
                                        )
                                      }
                                  ...
                                  contactAccess?.view ? (
                                    <MenuItem
                                      ...
                                      onClick={() =>
                                        navigate(
                                          cell?.row?.original?.createBy &&
                                            `/contactView/${cell?.row?.original.createBy}`
                                        )
                                      }
                                      icon={
                                        cell?.row?.original.createBy && (
                                          <IoIosContact mb={1} fontSize={15} />
                                        )
                                      }
                                    >
                                      {" "}
                                  ...
                                  leadAccess?.view ? (
                                    <MenuItem
                                      ...
                                      onClick={() =>
                                        navigate(
                                          `/leadView/${cell?.row?.original.createByLead}`
                                        )
                                      }
                                      icon={
                                        cell?.row?.original.createByLead &&
                                        leadAccess?.view && (
                                          <MdLeaderboard mb={1} fontSize={15} />
                                        )
                                      }
                                    >
                                      {cell?.row?.original.createByLead &&
