        ...
        (item) =>
          (!values?.projectName ||
            (item?.projectName &&
              item?.projectName
                .toLowerCase()
                .includes(values?.projectName?.toLowerCase()))) &&
          (!values?.listingPrice ||
            (item?.listingPrice &&
              item?.listingPrice
                .toString()
                .includes(values?.listingPrice?.toLowerCase()))) &&
          (!values?.squareFootage ||
            (item?.squareFootage &&
              item?.squareFootage
                .toString()
                .includes(values?.squareFootage))) &&
          (!values?.unitType ||
            (item?.unitType &&
              item?.unitType.toString().includes(values?.unitType))) &&
          ...
          (!values?.numberOfBathrooms ||
            (item?.numberofBathrooms &&
              item?.numberofBathrooms.toString() === values?.numberOfBathrooms))
      );
          ...
          >
            <Menu isLazy>
              ...
              >
                ...
                <MenuItem
                  width={"165px"}
                  onClick={() => handleExportProperties("xlsx")}
                >
                  {selectedValues && selectedValues?.length > 0
                  ...
                  return (
                    <Tr {...row?.getRowProps()} key={i}>
                      {row?.cells?.map((cell, index) => {
                        ...
                        if (cell?.column.Header === "#") {
                        ...
                        } else if (cell?.column.Header === "Unit Type") {
                          data = (
                            <Text
                              color={textColor}
                              fontSize="sm"
                          ...
                          cell?.column.Header === "number of Bedrooms"
                        ) {
                          data = (
                            <Text
                              color={textColor}
                          ...
                          cell?.column.Header === "number of Bathrooms"
                        ) {
                          data = (
                            <Text
                              color={textColor}
                                ...
                                >
                                  ...
                                  {access?.view && (
                                    <MenuItem
                                      ...
                                      onClick={() =>
                                        navigate(
                                          `/propertyView/${cell?.row?.values?._id}`
                                        )
                                      }
                                  ...
                                  {access?.delete && (
                                    <MenuItem
                                      ...
                                      icon={<DeleteIcon mb={1} fontSize={15} />}
                                    >
                                      Delete
                                    </MenuItem>
                                  )}
