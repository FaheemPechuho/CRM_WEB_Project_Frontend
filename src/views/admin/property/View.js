                                    ...
                                    <GridItem colSpan={{ base: 12, md: 6 }}>
                                        <Card >
                                            <Grid templateColumns="repeat(12, 1fr)" gap={4}>
                                                ...
                                                <GridItem colSpan={{ base: 12, md: 6 }}>
                                                    <Text color={'blackAlpha.900'} fontSize="sm" fontWeight="bold"> Project Name</Text>
                                                    <Text>{data?.projectName ? data?.projectName : 'N/A'}</Text>
                                                </GridItem>
                                                <GridItem colSpan={{ base: 12, md: 6 }}>
                                                ...
                                                <GridItem colSpan={{ base: 12, md: 6 }}>
                                                    ...
                                                    <Text>{data?.squareFootage ? data?.squareFootage : 'N/A'}</Text>
                                                     ...
                                                     <GridItem colSpan={{ base: 12, md: 6 }}>
                                                    <Text color={'blackAlpha.900'} fontSize="sm" fontWeight="bold"> Unit Type</Text>
                                                    <Text>{data?.unitType ? data?.unitType : 'N/A'}</Text>
                                                </GridItem>
                                                <GridItem colSpan={{ base: 12, md: 6 }}>
